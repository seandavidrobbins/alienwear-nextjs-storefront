...
import IsAboutPageTemplate from "functions/isAboutPageTemplate";
    ...
    return (
      ...
      <Image
        ...
        className={cn(
          ...
          IsAboutPageTemplate(props) ? styles.aboutImage : styles.image
        )}
      />
    );
  }
  ...
  function HtmlImage() {
    return (
      <img
        ...
        className={cn(
          props?.className,
          IsAboutPageTemplate() ? styles.aboutImage : styles.image
        )}
