...
export default function Meta({ seo }) {
  ...
  return (
    <Head>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Orbitron:wght@400;900&family=Rajdhani:wght@300;400;500;600;700&family=Work+Sans:wght@100;300;400;500;600;700;800&display=swap"
        rel="stylesheet"
      />
    </Head>
  );
