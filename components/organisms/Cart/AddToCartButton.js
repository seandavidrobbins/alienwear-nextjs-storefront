...
import { getFormattedCart } from "functions/wordpress/blocks/functions";
import GET_CART from "functions/wordpress/queries/get-cart";
import ADD_TO_CART from "functions/wordpress/mutations/add-to-cart";
    ...
    <div>
      ...
      {"ExternalProduct" === product.__typename ? (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="px-3 py-1 rounded-sm mr-3 text-sm border-solid border border-current inline-block text-white hover:bg-purple-600 hover:text-white hover:border-purple-600"
        >
          Buy now
        </a>
      ) : (
