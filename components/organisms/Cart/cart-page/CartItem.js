...
import { v4 } from "uuid";
import { getUpdatedItems } from "functions/wordpress/blocks/functions";
import { Cross, Loading } from "components/atoms/icons";
    ...
    <tr className="woo-next-cart-item" key={item.productId}>
      ...
      <td className="woo-next-cart-element woo-next-cart-qty">
        ...
        <input
          ...
          className={`woo-next-cart-qty-input form-control  mx-2 !text-black ${
