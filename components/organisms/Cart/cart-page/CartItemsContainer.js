...
import {
  getFormattedCart,
  getUpdatedItems,
} from "functions/wordpress/blocks/functions";
import CartItem from "components/organisms/Cart/cart-page/CartItem";
import { v4 } from "uuid";
import { useMutation, useQuery } from "@apollo/client";
import UPDATE_CART from "functions/wordpress/mutations/update-cart";
...
const CartItemsContainer = () => {
  ...
  return (
    <div className="cart product-cart-container container mx-auto my-48">
      {cart ? (
              ...
              <div>
                ...
                <Link href="/checkout">
                  <button className="bg-purple-600 text-white px-5 py-3 rounded-sm w-auto xl:w-full">
                    <span className="woo-next-cart-checkxout-txt">
                      Proceed to Checkout
                    </span>
