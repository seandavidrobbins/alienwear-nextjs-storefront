...
import validateAndSanitizeCheckoutForm from "functions/wordpress/validator/checkout";
import {
  getFormattedCart,
  createCheckoutData,
...
import CHECKOUT_MUTATION from "functions/wordpress/mutations/checkout";
...
import {
  ...
  setStatesForCountry,
} from "functions/wordpress/utils/checkout";
    ...
    <>
      {cart ? (
        <form
          ...
          className="woo-next-checkout-form text-white"
        >
